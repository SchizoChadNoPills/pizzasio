    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center" style="background-color: #225332" ;>
            <div class="d-flex flex-column flex-center p-6  w-100">
                ...
                <!--begin::Image-->
                <img class="d-lg-block justify-content align-content mx-auto w-100px w-lg-100 w-xl-75" src="<?= site_url('assets/media/logos/PizzaSioFullLogoWhite.svg'); ?>" alt="" />
                <!--end::Image-->
            </div>
            <!--end::Content-->
        </div>
